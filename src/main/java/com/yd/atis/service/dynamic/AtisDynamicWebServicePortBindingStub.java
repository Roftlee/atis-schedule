/**
 * AtisDynamicWebServicePortBindingStub.java
 *
...
public class AtisDynamicWebServicePortBindingStub extends org.apache.axis.client.Stub implements AtisDynamicWebService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "segmentID"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "arriveLeaveType"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "arriveStationBusEntity"));
        oper.setReturnClass(ArriveStationBusEntity[].class);
    ...
    public AtisDynamicWebServicePortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AtisDynamicWebServicePortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AtisDynamicWebServicePortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            qName = new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "arriveStationBusEntity");
            cachedSerQNames.add(qName);
            cls = ArriveStationBusEntity.class;
            ...
            qName = new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "realTimeInfo");
            cachedSerQNames.add(qName);
            cls = RealTimeInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public ArriveStationBusEntity[] queryByStationID2(String routeID, String segmentID, String stationID, int arriveLeaveType, String name, String password) throws java.rmi.RemoteException, BusinessException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "queryByStationID2"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {routeID, segmentID, stationID, new Integer(arriveLeaveType), name, password});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (ArriveStationBusEntity[]) _resp;
            } catch (Exception _exception) {
                return (ArriveStationBusEntity[]) org.apache.axis.utils.JavaUtils.convert(_resp, ArriveStationBusEntity[].class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public RealTimeInfo[] queryDetailByRouteID2(String routeID, String stationID, String segmentID, int arriveLeaveType, String name, String password) throws java.rmi.RemoteException, BusinessException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "queryDetailByRouteID2"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {routeID, stationID, segmentID, new Integer(arriveLeaveType), name, password});
  ...
  throw axisFaultException;
    ...
    public RealTimeInfo[] queryDetailByRouteID(String routeID, String stationID, String segmentID, String name, String password) throws java.rmi.RemoteException, BusinessException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "queryDetailByRouteID"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {routeID, stationID, segmentID, name, password});
  ...
  throw axisFaultException;
    ...
    public StationInfoEntity[] requireRouteSpeed(String routeID, String name, String password) throws java.rmi.RemoteException, BusinessException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "requireRouteSpeed"));
 ...
 try {        Object _resp = _call.invoke(new Object[] {routeID, name, password});
  ...
  throw axisFaultException;
    ...
    public ArriveStationBusEntity[] requireBusPosition(String routeID, String segmentID, String stationID, String name, String password) throws java.rmi.RemoteException, BusinessException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "requireBusPosition"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {routeID, segmentID, stationID, name, password});
  ...
  throw axisFaultException;
    ...
    public ArriveStationBusEntity[] queryByStationID(String routeID, String segmentID, String stationID, String name, String password) throws java.rmi.RemoteException, BusinessException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://webservice.atis.hisense.com/", "queryByStationID"));
